      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
        ...
        <div className="flex items-center space-x-3">
          <button 
            ...
            className="flex items-center space-x-1 px-2 py-1 text-xs text-gray-600 hover:text-blue-600 hover:bg-white rounded transition-colors border border-transparent hover:border-blue-200"
      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute bottom-4 right-4 flex items-center space-x-3 text-xs text-gray-400">
          <span className="bg-gray-800 px-2 py-1 rounded shadow-sm border border-gray-700">
            {Math.ceil(content.length > 0 ? content.trim().split(/\s+/).length / 200 : 0)} min read
          </span>
          <span className="bg-gray-800 px-2 py-1 rounded shadow-sm border border-gray-700">
